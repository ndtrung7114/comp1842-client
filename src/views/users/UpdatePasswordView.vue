          ...
          <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
              <div class="text-center mb-4">
                ...
                <p class="text-muted">Please enter your current password and choose a new strong password</p>
              </div>
              ...
              <form @submit.prevent="handleSubmit" class="space-y-4">
                ...
                <div class="mb-4">
                  ...
                  <div class="invalid-feedback" v-if="v$.currentPassword.$error">
              ...
              <div v-if="successMessage" class="alert alert-success">
                ...
                <div class="d-grid gap-2">
                  <button 
                    ...
                    :disabled="isSubmitting || !isPasswordStrong || v$.$invalid"
                  >
...
// Get userId from route params instead of auth store for this view
...
function checkPasswordMatch() {
  if (formData.confirmPassword && formData.newPassword) {
    passwordMismatch.value = formData.newPassword !== formData.confirmPassword
  } else {
...
const rules = computed(() => ({
  ...
  confirmPassword: { 
    required,
    sameAsPassword: sameAs(computed(() => formData.newPassword))
  }
}))
...
async function handleSubmit() {
  ...
  try {
    ...
    await authStore.updatePassword(userId.value, {
